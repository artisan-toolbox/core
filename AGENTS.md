...
- Keep package names, namespaces, Composer metadata, publish tags, documentation, and examples aligned with `artisan-toolbox/core`.
...
- `package-testing`: use when adding or changing package tests with Pest 5 and Orchestra Testbench 11.
